...
export const Route = createFileRoute("/insights/krishi-khate-biniyog")({
  head: () => ({
    meta: [
      { title: "বাংলাদেশের কৃষি খাতে বিনিয়োগের সম্ভাবনা ও ঝুঁকি · সমৃদ্ধি" },
      {
        name: "description",
        content:
...
const SECTIONS = [
  ...
  },
  {
    ...
    title: "সমৃদ্ধির মাধ্যমে ঝুঁকি নিয়ন্ত্রণ",
    paragraphs: [
      "এই ঝুঁকিগুলো এড়ানোর জন্য সমৃদ্ধি একটি নিয়মতান্ত্রিক প্রক্রিয়ায় কাজ করে। আমরা এমন খামার বা কৃষি উদ্যোক্তাদের নির্বাচন করি, যাদের পর্যাপ্ত অভিজ্ঞতা আছে এবং যারা আধুনিক উপায়ে খামার পরিচালনা করেন।",
