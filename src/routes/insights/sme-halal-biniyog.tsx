...
export const Route = createFileRoute("/insights/sme-halal-biniyog")({
  head: () => ({
    meta: [
      { title: "এসএমই ব্যবসায় হালাল বিনিয়োগের গুরুত্ব এবং পদ্ধতি · সমৃদ্ধি" },
      {
        name: "description",
        content:
...
const SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "দ্বিতীয়ত, উদ্যোক্তার সততা ও অভিজ্ঞতা যাচাই করা। তৃতীয়ত, একটি সঠিক ও আইনি চুক্তি (Legal Agreement) করা, যেখানে মুদারাবা বা মুশারাকা নীতির আওতায় লাভ-ক্ষতির হার স্পষ্টভাবে উল্লেখ থাকবে। সমৃদ্ধি প্ল্যাটফর্ম ঠিক এই কাজটিই বিনিয়োগকারীদের জন্য সহজ করে দিয়েছে।",
