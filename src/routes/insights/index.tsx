...
const ARTICLES = [
  {
    ...
    excerpt: "ব্যবসায়ীর সাথে সরাসরি সংযোগ, সুদমুক্ত আয়, আইনি সুরক্ষা, স্বচ্ছ চুক্তি — জেনে নিন কেন সমৃদ্ধি বাংলাদেশের সবচেয়ে বিশ্বস্ত হালাল বিনিয়োগ প্ল্যাটফর্ম।",
    date: "৩১ জুলাই ২০২৬",
    readTime: "৮ মিনিট",
  ...
  },
  {
    ...
    excerpt: "মুদ্রাস্আতির কারণে টাকার মান কমে যাচ্ছে। এই সময়ে শুধুমাত্র সঞ্চয় না করে কীভাবে একটি স্মার্ট ইনভেস্টমেন্ট পোর্টফোলিও তৈরি করবেন তা নিয়ে কিছু কার্যকরী টিপস।",
    date: "০৫ জুলাই ২০২৬",
    readTime: "৬ মিনিট",
    author: "মোহাইমিন পাটোয়ারী",
    category: "বিনিয়োগ গাইড",
