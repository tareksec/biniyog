...
export const Route = createFileRoute("/insights/inflation-portfolio")({
  head: () => ({
    meta: [
      { title: "ইনফ্লেশনের সময়ে নিজের পোর্টফোলিও কীভাবে সাজাবেন? · বিনিয়োগ বৃদ্ধি" },
      {
        name: "description",
        content:
...
const SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "উদাহরণস্বরূপ, আপনি আপনার বিনিয়োগযোগ্য তহবিলের একটি অংশ ট্রেডিং ব্যবসায়, আরেকটি অংশ কৃষি খাতে এবং বাকি অংশ ম্যানুফ্যাকচারিং খাতে বিনিয়োগ করতে পারেন। এতে কোনো একটি ব্যবসায় ক্ষতি হলেও অন্যগুলোর লাভে আপনার সামগ্রিক পোর্টফোলিও ইতিবাচক থাকবে। বিনিয়োগ বৃদ্ধি প্ল্যাটফর্মে আমরা এই ডাইভারসিফিকেশনের সুযোগটিই করে দেই।",
    ],
  },
];
