...
export const Route = createFileRoute("/insights/keno-somriddhite-biniyog")({
  head: () => ({
    meta: [
      { title: "কেন সমৃদ্ধিতে বিনিয়োগ করবেন — সম্পূর্ণ গাইড · সমৃদ্ধি" },
      {
        name: "description",
        content:
          "ব্যবসায়ীর সাথে সরাসরি সংযোগ, সুদমুক্ত আয়, আইনি সুরক্ষা, স্বচ্ছ চুক্তি — জেনে নিন কেন সমৃদ্ধি বাংলাদেশের সবচেয়ে বিশ্বস্ত হালাল বিনিয়োগ প্ল্যাটফর্ম।",
      },
    ],
  }),
...
const SECTIONS = [
  {
    ...
    paragraphs: [
      "প্রচলিত বিনিয়োগ প্ল্যাটফর্মগুলোতে আপনি সাধারণত একটি মধ্যস্থতাকারীর মাধ্যমে বিনিয়োগ করেন — আপনি জানেন না আপনার টাকা কোথায় যাচ্ছে, কে ব্যবহার করছে, বা সেই ব্যবসাটি আসলেই আছে কিনা। সমৃদ্ধি এই ধারণাটিকেই পাল্টে দেয়। এখানে আপনি সরাসরি ব্যবসায়ীর সাথে সংযুক্ত হন, তার সাথে কথা বলতে পারেন, তার ব্যবসার খোঁজখবর নিতে পারেন, এবং নিজেই সিদ্ধান্ত নিতে পারেন যে আপনি এই ব্যবসায় বিশ্বাস করেন কিনা।",
  ...
  },
  {
    ...
    paragraphs: [
      "বাংলাদেশের মুসলিম জনগোষ্ঠীর জন্য সুদ একটি বড় উদ্বেগের বিষয়। দুর্ভাগ্যজনকভাবে, আমাদের দেশের অধিকাংশ বিনিয়োগ ও সঞ্চয়পত্র কোনো না কোনোভাবে সুদের সাথে জড়িত — কখনো সরাসরি, কখনো ঘুরিয়ে। সমৃদ্ধি সম্পূর্ণ ভিন্ন পথে হাঁটে। আমরা মুদারাবা ও মুশারাকার মতো ইসলামী ফাইন্যান্স নীতির উপর ভিত্তি করে কাজ করি, যেখানে বিনিয়োগকারী ও ব্যবসায়ী লাভ-ক্ষতি উভয়ই ভাগ করে নেন।",
      ...
      "আমরা কোনো প্রকার 'ঘুরিয়ে সুদ' খাওয়ার কৌশল প্রয়োগ করি না। আপনি যখন সমৃদ্ধির সাথে যুক্ত হন, আপনি নিশ্চিত থাকতে পারেন যে আপনার সম্পূর্ণ উপার্জন প্রক্রিয়াটি ইসলামী শরীয়াহ মোতাবেক হালাল — এবং এই বিষয়ে আমরা কোনো আপস করি না। এটি কেবল একটি বিজ্ঞাপনী দাবি নয়, বরং আমাদের পুরো ব্যবসায়িক মডেলের ভিত্তি।",
    ],
  },
  {
    id: "legal",
  ...
  },
  {
    ...
    paragraphs: [
      "অধিকাংশ বিনিয়োগ প্ল্যাটফর্মে অন্ধকারে ঢিল ছোঁড়ার মতো বিনিয়োগ করতে হয় — আপনি টাকা দেন, তারপর অপেক্ষা করেন। মাস শেষে কিছু রিটার্ন পান, কিন্তু জানেন না সেই লাভ কীভাবে হলো, আসল ব্যবসায় কেমন চলছে, বা আপনার টাকা দিয়ে আদৌ কী হচ্ছে। সমৃদ্ধি এই অস্বচ্ছতার অবসান ঘটায়। আমাদের মডেলে আপনি প্রতি মাসে একটি বিস্তারিত আর্থিক প্রতিবেদন পান, যেখানে স্পষ্ট থাকে ব্যবসার আয়, ব্যয়, নীট লাভ, এবং আপনার প্রাপ্য অংশ।",
  ...
  },
  {
    ...
    paragraphs: [
      "একটি বিজনেস প্রোফাইল দেখে বা অনলাইন রিভিউ পড়ে বিনিয়োগ করা এক জিনিস, আর নিজে গিয়ে সরেজমিনে দেখা সম্পূর্ণ ভিন্ন জিনিস। সমৃদ্ধি বিনিয়োগকারীদের বিনিয়োগের আগে এবং পরেও সরেজমিনে ব্যবসা পরিদর্শনের সুযোগ দেয়। আপনি চাইলে ব্যবসার লোকেশন, ফ্যাক্টরি, অফিস, গুদাম — সবকিছু নিজের চোখে দেখতে পারেন।",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "তবে এখানে একটি গুরুত্বপূর্ণ বিষয় পরিষ্কার করে বলা প্রয়োজন: বেশি লাভের অর্থ সবসময় বেশি ঝুঁকিও বটে। সমৃদ্ধি কখনোই গ্যারান্টিড রিটার্নের প্রতিশ্রুতি দেয় না। কোনো ব্যবসা ভালো করলে আপনি ব্যাংকের চেয়ে অনেক বেশি পাবেন, আবার খারাপ করলে ক্ষতিও হতে পারে। কিন্তু আমাদের যাচাই প্রক্রিয়া, আইনি কাঠামো, এবং স্বচ্ছ রিপোর্টিং এই ঝুঁকি যতটা সম্ভব কমানোর জন্য নকশা করা হয়েছে। আমরা বিশ্বাস করি, বাস্তবসম্মত প্রত্যাশা নিয়েই একজন বুদ্ধিমান বিনিয়োগকারী দীর্ঘমেয়াদে সফল হন।",
  ...
  },
  {
    ...
    paragraphs: [
      "সব ব্যবসা সমাজের জন্য সমানভাবে উপকারী নয়। ক্ষতিকর পণ্য (যেমন তামাক, অ্যালকোহল), ফটকাবাজি, জুয়া, বা অস্বাস্থ্যকর খাদ্যপণ্যের ব্যবসা সমাজ ও ব্যক্তির জন্য ক্ষতির কারণ হয়। সমৃদ্ধি এসব ব্যবসাকে কখনোই তার প্ল্যাটফর্মে স্থান দেয় না। আমরা কেবলমাত্র সেই সব ব্যবসা বাছাই করি যেগুলো সমাজের জন্য প্রকৃত মূল্য তৈরি করে — যেমন কৃষি, হালাল খাদ্য প্রক্রিয়াকরণ, পোশাক শিল্প, তথ্যপ্রযুক্তি, নবায়নযোগ্য জ্বালানি, এবং স্বাস্থ্যসেবা।",
      "আমাদের দর্শন সহজ: আপনার বিনিয়োগ শুধু আপনাকেই ধনী করবে না, বরং সমাজকেও সমৃদ্ধ করবে। যখন আপনি একটি কৃষি প্রক্রিয়াকরণ কারখানায় বিনিয়োগ করেন, আপনি শুধু লাভই করেন না — আপনি কৃষকদের ন্যায্যমূল্য পেতে সাহায্য করেন, গ্রামীণ কর্মসংস্থান সৃষ্টি করেন, এবং দেশের খাদ্য নিরাপত্তায় অবদান রাখেন। এই ত্রিমুখী জয়ের ধারণা — আপনার লাভ, ব্যবসায়ীর উন্নতি, এবং সমাজের কল্যাণ — সমৃদ্ধির বিনিয়োগ দর্শনের মূলভিত্তি।",
      "আমরা বিশ্বাস করি 'এথিক্যাল ইনভেস্টিং' বা নৈতিক বিনিয়োগ শুধু পশ্চিমা দেশগুলোর বিলাসিতা নয়। বাংলাদেশের মতো উন্নয়নশীল দেশে এর প্রয়োজন আরও বেশি। কারণ এখানে সীমিত সম্পদ যখন সঠিক খাতে বিনিয়োগ হয়, তখন তার গুণগত প্রভাব অনেক বেশি হয়। সমৃদ্ধির সাথে বিনিয়োগ করে আপনি শুধু একটি আর্থিক সিদ্ধান্তই নিচ্ছেন না, একটি মূল্যবোধের পক্ষেও দাঁড়াচ্ছেন।",
    ],
  },
];
      ...
      <main className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-16">
        ...
        <div className="mb-12">
          ...
          <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
            বাংলাদেশে হালাল ও স্বচ্ছ উপায়ে SME ব্যবসায় বিনিয়োগের সুযোগ দিন দিন বাড়ছে। কিন্তু সঠিক প্ল্যাটফর্ম বেছে নেওয়া সহজ নয়। সমৃদ্ধি কেন আপনার আস্থার পাত্র হতে পারে — চলুন বিস্তারিত জেনে নিই।
          </p>
