...
const ARTICLES = [
  {
    ...
    excerpt: "হালাল বিনিয়োগ শুধু একটি ধর্মীয় দায়িত্ব নয়, বরং এটি একটি টেকসই ও নিরাপদ অর্থনৈতিক ব্যবস্থা গড়ে তুলতে সাহায্য করে। বিস্তারিত জানুন কীভাবে এসএমই খাতে শরীয়াহ সম্মত বিনিয়োগ করা যায়।",
    date: "২০ জুলাই ২০২৬",
    readTime: "৫ মিনিট",
