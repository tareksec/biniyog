  ...
  return (
    <footer className="bg-card border-t border-border mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-16 pb-28 sm:pt-24 sm:pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.instagram.com/mohaiminpatwary" target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="/#how" className="text-muted-foreground hover:text-primary transition-colors inline-flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-primary/40"></span>
                  কিভাবে কাজ করে
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="/#faq" className="text-muted-foreground hover:text-primary transition-colors inline-flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-primary/40"></span>
                  সাধারণ জিজ্ঞাসা (FAQ)
                </a>
              </li>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <a 
                  ...
                  className="text-[15px] hover:text-primary transition-colors underline underline-offset-4"
                >
        ...
        {/* Warning Banner */}
        <div className="mt-12 sm:mt-16 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4 text-xs sm:text-sm leading-relaxed text-amber-800 dark:text-amber-400 flex items-start sm:items-center justify-center gap-2.5 max-w-4xl mx-auto shadow-sm text-center sm:text-left">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" className="mt-0.5 sm:mt-0 shrink-0 text-amber-600 dark:text-amber-400"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 sm:mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © {currentYear} সমৃদ্ধি (Samriddhi). সর্বস্বত্ব সংরক্ষিত।
          </p>
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4 text-sm text-muted-foreground font-medium mt-4 md:mt-0 relative z-20">
            <span>প্রকৃত ব্যবসা বিনিয়োগ</span>
            <span className="hidden md:inline">·</span>
            <span className="flex items-center gap-1.5">
              Developed by <a href="https://artx.techvrs.com/" target="_blank" rel="noopener noreferrer" className="relative z-50 hover:text-primary transition-colors underline underline-offset-4">ArtX TechVRS</a>
              <a href="https://www.linkedin.com/in/mdtarek404/" target="_blank" rel="noopener noreferrer" className="relative z-50 text-muted-foreground hover:text-primary transition-colors inline-flex ml-1 p-1 -m-1" aria-label="Developer LinkedIn">
