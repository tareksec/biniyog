...
const ITEMS = [
  ...
  },
  {
    ...
    initials: "আস",
    quote:
      "শরীয়াহ কমপ্লায়েন্স ছিল আমার প্রথম প্রায়োরিটি। প্রতিটি প্রজেক্টের সোর্স অফ ইনকাম আগেই যাচাই করে জানানো হয় — এটাই আসল পার্থক্য।",
  },
  {
    name: "তানভীর হোসেন",
    ...
    initials: "তহ",
    quote:
      "আমার এগ্রো বিজনেসে দ্রুত তহবিল পেয়েছি সুদ ছাড়াই। পার্টনারশিপ মডেলের কারণে চাপ কম, ফোকাস ব্যবসায়।",
  },
  {
    name: "সাদিয়া রহমান",
    role: "বিনিয়োগকারী · ঢাকা",
