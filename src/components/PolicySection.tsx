...
const BROAD_POLICIES: BroadPolicy[] = [
  {
    ...
    description: "আমরা শুধুমাত্র লাভজনক, হালাল এবং সম্ভাবনাময় ব্যবসা বাছাই করি। স্বপ্নচারী বা পূর্ব অভিজ্ঞতা নেই এমন ব্যবসা এবং যা কিছু ব্যবসার মূল লাভের সাথে সম্পর্কিত নয় এমন ব্যয়কে আমরা পরিহার করি।",
    points: [
      "লোকসান করছে বা দ্রুত বন্ধ হওয়ার ঝুঁকিতে থাকা কোম্পানি বাতিল।",
      "শখের বসে অপ্রয়োজনীয় ব্যয় করা ব্যবসা গ্রহণযোগ্য নয়।",
      "প্রতিষ্ঠাতার মোট বিনিয়োগ দায়ের তুলনায় ৫০% এর কম হলে সতর্কভাবে বিবেচনা।",
  ...
  },
  {
    ...
    description: "উদ্যোক্তার সততা, ব্যবসায়িক দক্ষতা এবং ব্যক্তিজীবন গভীরভাবে যাচাই করা হয়। পূর্ব পরিচিতি, বাজার যাচাই এবং ব্যক্তিগত রুদ্ধদ্বার ইন্টারভিউয়ের মাধ্যমে আমরা যোগ্য উদ্যোক্তা নির্বাচন করি।",
    points: [
  ...
  },
  {
    ...
    points: [
      ...
      "ফাইন্যান্সিয়াল স্টেটমেন্ট ও সকল একাউন্টিং তথ্য নিয়মিত মনিটরিং করা।",
      "প্রতারণা বা জালিয়াতির প্রমাণ পাওয়া মাত্রই জনস্বার্থে পাবলিক নোটিশ প্রদান।",
      "অনলাইনে বিজ্ঞাপন দিয়ে ফান্ড কালেক্ট বা কৃষি কাজে ফান্ড ডাইভার্ট বাতিল।"
    ],
    icon: ShieldAlert
  },
  {
    ...
    description: "আমরা কেবল মানসম্পন্ন ব্যবসার প্রস্তাব দিই, কিন্তু চূড়ান্ত সিদ্ধান্ত ও দায় বিনিয়োগকারীর। বিনিয়োগকারীদের অবশ্যই ব্যবসায়িক মানসিকতা নিয়ে, সুদের চিন্তা পরিহার করে এবং উদ্যোক্তাদের প্রতি সম্মানজনক আচরণ বজায় রেখে যুক্ত হতে হবে।",
    points: [
  ...
  },
  {
    ...
    description: "আমরা যাচাই-বাছাইয়ের জন্য ফি নিই এবং বিনিয়োগকারীদের সাথে সরাসরি কোনো আর্থিক লেনদেন করি না। মানুষ হিসেবে আমাদের কোনো ভুল-ভ্রান্তি হলে আমরা ক্ষমাপ্রার্থী এবং সবার সহযোগিতায় একটি সুস্থ ও হালাল বিনিয়োগ পরিবেশ তৈরি করতে আমরা অঙ্গীকারবদ্ধ।",
    points: [
      "আমরা যাচাই-বাছাইয়ের বিনিময়ে শুধু ব্যবসায়ীদের থেকে ফি গ্রহণ করি।",
      "বিনিয়োগকারীদের সাথে আমাদের কোনো প্রকার আর্থিক লেনদেন হয় না।",
      "মানুষ হিসেবে আমাদের কোনো ভুল-ভ্রান্তি হলে আমরা ক্ষমাপ্রার্থী।",
      "সবার সহযোগিতায় একটি সুস্থ ও হালাল বিনিয়োগ পরিবেশ তৈরিতে আমরা দায়বদ্ধ।"
    ],
    icon: HeartHandshake
  }
];
      ...
      <div ref={containerRef} className="px-5 sm:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 sm:mb-32">
          ...
          <p className="mt-4 text-base text-muted-foreground sm:text-lg">
            স্বচ্ছতা, নিরাপত্তা ও নৈতিকতার সাথে হালাল বিনিয়োগ পরিচালনার জন্য আমাদের অনুসৃত ৫টি মূল ভিত্তি।
          </p>
        </div>
