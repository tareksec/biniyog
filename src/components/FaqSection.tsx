...
const FAQS = [
  {
    ...
    a: "পার্টনারশিপ মডেল হলো এমন একটি ব্যবসায়িক কাঠামো যেখানে দুই বা ততোধিক ব্যক্তি বা প্রতিষ্ঠান একত্রিত হয়ে কাজ করে। এখানে সবাই যৌথভাবে মূলধন বিনিয়োগ করে এবং চুক্তির শর্ত অনুযায়ী অর্জিত লাভ বা ক্ষতি নিজেদের মধ্যে ভাগ করে নেয়।",
  },
  {
    q: "ট্রেডিং পার্টনার বা পণ্যে বিনিয়োগ বা মুদারাবা কিভাবে কাজ করে?",
