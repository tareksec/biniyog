...
export function InstructorSection() {
  return (
    <section id="expert" className="border-t border-border bg-surface">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          <div className="relative">
            ...
            <div className="mt-6 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
              <div
                className="grid h-24 w-24 place-items-center rounded-2xl text-3xl font-bold text-primary-foreground"
