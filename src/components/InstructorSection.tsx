        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-[15px] leading-[1.9] text-foreground/85">
              ...
              <br />
              এই নিয়ে ওনার মোট ১০টি বই এবং বিভিন্ন শীর্ষ সারির পত্রিকাতে লেখা প্রকাশিত হয়েছে।
              <br />
              ভ্রমণ করতে পছন্দ করেন। এই নিয়ে ২০ টিরও বেশি দেশে ভ্রমণ এবং সুদমুক্ত ভাবে মানুষকে আর্থিক ক্ষমতায়িত করার দীর্ঘ অভিজ্ঞতা রয়েছে।
            </p>
